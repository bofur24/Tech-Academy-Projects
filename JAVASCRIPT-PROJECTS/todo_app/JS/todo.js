...
function get_todos() {
    ...
    var todos = new Array;
    // This pulls the task that was saved in the web browser memeory
    var todos_str = localStorage.getItem('todo');
    // If  the input is not null then JASON.parse will
...
// This function adds the inputed task to the get_tods function array
function add() {
    // This takes the inputed task and creates a variable of it
    var task = document.getElementById('task').value;

    var todos = get_todos();
    // This adds a new task at and end of the array
    todos.push(task);
...
// This creates the funcionality of removing a tod item from the array
function remove() {
