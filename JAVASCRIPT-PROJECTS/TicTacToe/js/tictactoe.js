...
function placeXorO(squareNumber) {
    ...
    // The .some() method is used t ocheck each element of the selectSquare array
    // to see if it contasin the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            // This funciton disables clicking for computers turn.
            disableClick();
    ...
    function computersTurn() {
        // This boolean is needed for our whild loop.
        let success = false;
...
// This function parses the selectedSquares array to search for wind conditions. drawLine() function is called to draw a line on the screen if the condition is met.
function checkWinConditions() {
    ...
    // This function checks if an array includes 3 strings. It is used for 
    // each win condition.
...
function audio(audioURL) {
    ...
    // Play method plays our audio sould.
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDraiwng() {
        // This variable creates a loop
        const animationLoop = requestAnimationFrame(animateLineDraiwng);
        ...
        // This metod draws everything we laid out above.
        c.stroke();
