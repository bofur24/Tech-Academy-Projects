...
const Calculator = {
        ...
        First_Operand: null,
        // This checks wheter or not the second operand has been inputted by the user.
...
function Input_Decimal(dot) {
        ...
        if (!Calculator.Display_Value.includes(dot)) {
                ...
                // we want t oadd a decimal point.
...
function Update_Display() {
        // Makes use of the calculator-screen class to tartget the 
