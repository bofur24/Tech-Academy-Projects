...
function showSlides(n) {
    ...
    var dots = document.getElementsByClassName("dot"); // This takes all elements with the class name "dot" and stores them in varable array "dots"
    ...
    if (n < 1) {slideIndex = slides.length}; // If n (the number passed into the fundcion) is less than 1, the slideIndex is set to the length of the array "slides"
